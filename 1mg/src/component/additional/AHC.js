...
function AHC() {
    return (
        <>
            <section className="flex flex-col md:flex-row items-center justify-between p-6 bg-white rounded-xl gap-6">
                <div className="md:w-1/2 space-y-4">
                    ...
                    <button
                        ...
                        className="mt-8 border-2 border-transparent ease-out-in bg-[#ff6f61] hover:bg-transparent hover:border-2 hover:border-[#ff6f61]  hover:text-[#ff6f61] text-white text-lg font-semibold py-3 px-6 rounded-lg transition duration-200"
                    >
